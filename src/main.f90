!> Main entry point for the LowMach-Hex hexahedral low-Mach FV solver.
program hex_lowmach_fv
   use mpi_f08
   ...
   if (flow_mpi%rank == 0) then
      write(output_unit,'(a)') 'LowMach-Hex hexahedral low-Mach FV solver'
