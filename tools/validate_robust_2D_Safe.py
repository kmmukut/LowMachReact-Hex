...
Path behavior:
  If input is under cases/<case>/output/VTK/, generated validation CSVs and
  images are written to cases/<case>/validation/ by default.
...
def default_validation_dir(vtu_path: str | Path) -> Path:
    ...
    Supported layouts:
      ...
      cases/foo/output/VTK/flow_001000.vtu
        -> cases/foo/validation
    ...
    # New layout:
    #   cases/<case>/output/VTK/flow_*.vtu or flow_*.pvtu
