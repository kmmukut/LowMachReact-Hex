...
The LowMach-Hex solver uses a collocated finite-volume method on structured hexahedral meshes to solve the incompressible Navier-Stokes and species transport equations.
