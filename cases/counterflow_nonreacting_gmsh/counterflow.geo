...
//   - The open y outlets give a constant-density projection solve somewhere
//     to discharge the mass injected by the opposed x inlets.
//
// Generate native mesh:
//   ./make_mesh.sh
//
// Physical patch names: xmin, xmax, ymin, ymax, zmin, zmax (same as channel_flow).
