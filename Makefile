...
#
# Therefore:
#   - The real compiled ELF binary is build/hex_lowmach_fv.bin
#   - The top-level ./hex_lowmach_fv is a small launcher script
#   - The launcher prepends $CONDA_PREFIX/lib to LD_LIBRARY_PATH automatically
#
# Users still run:
#
#   ./hex_lowmach_fv cases/channel_flow/case.nml
#
# or:
#
#   mpirun -np 4 ./hex_lowmach_fv cases/channel_flow/case.nml
#
...
# Build the real executable as build/hex_lowmach_fv.bin.
...
#
# Users run ./hex_lowmach_fv exactly as before.
